...
function CollegeTable({ onRefresh }) {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const response = await axios.get(
                `https://capital-curve-apis.onrender.com/api/influencer/get-allinfluencer?page=${pageTable2}&limit=${resultsPerPage}`,
                {
                    headers: {
            ...
            if (response.data && response.data.result) {
                setDataTable2(response.data.result.influencer || []);
                setTotalPages(response.data.result.totalPages || 0);
                setTotalRecords(response.data.result.totalInfluencer || 0);
                onRefresh();
    ...
    const filteredData = useMemo(() => {
        ...
        return dataTable2.filter((item) =>
            ["ID", "influencerName", "influencerEmail", "influencerPlatform", "influencerPhonenumber", "collegeCode", "discountCode",].some((key) =>
    ...
    const columns = [
        ...
        columnHelper.accessor("influencerEmail", {
            id: "influencerEmail",
            header: () => (
        ...
        columnHelper.accessor("influencerPlatform", {
        ...
        columnHelper.accessor("influencerPhonenumber", {
            id: "influencerPhonenumber",
            header: () => (
        ...
        columnHelper.accessor("influencerStatus", {
            id: "influencerStatus",
            header: () => (
