...
import dummyData from "../variables/userDummy";
import {
    createColumnHelper,
    flexRender,
    getCoreRowModel,
...
function UserReferral() {
    ...
    const columns = [
        ...
        columnHelper.accessor("name", {
            id: "name",
            header: () => <p className="text-sm font-bold text-gray-600 dark:text-white flex justify-center items-center">Name</p>,
        ...
        columnHelper.accessor("Code", {
            id: "Code",
            header: () => <p className="text-sm font-bold text-gray-600 dark:text-white flex justify-center items-center">Code</p>,
        ...
        columnHelper.accessor("Referrer", {
            id: "Referrer",
            header: () => <p className="text-sm font-bold text-gray-600 dark:text-white flex justify-center items-center">Referrals</p>,
            cell: (info) => <p className="text-sm font-bold text-gray-600 dark:text-white flex justify-center items-center">{info.getValue()}</p>
        }),
        columnHelper.accessor("Commission", {
            id: "Commission",
            header: () =><p className="text-sm font-bold text-gray-600 dark:text-white flex justify-center items-center">Total Comission</p>,
            cell: (info) =><p className="text-md font-medium flex justify-center items-center text-gray-600 dark:text-white">{info.getValue()}</p>
        }),
        ...
        columnHelper.accessor("Action", {
            ...
            cell: (info) => (
                <div className="flex justify-center items-center gap-4">
                    <button aria-label="Block"><MdBlock className="text-red-400 text-lg" /></button>
                    <button aria-label="View"><FaEye className="text-yellow-500 text-lg" /></button>
                </div>
            ),
        }),
    ];
